...
function ColorPicker:Constructor(color, dimension)
    ...
    if (color) then
        color = WeaverVenomDisplay.Utils.Color(color.R, color.G, color.B);
    else
        color = WeaverVenomDisplay.Utils.Color(0.5, 1.0, 1.0);
    end
    ...
    self:SetText(L:GetText("DefaultTitle"));
    self:SetResizable(true);

    self.color = WeaverVenomDisplay.Utils.Color(1, 0.5, 0.5, 0.5);
    self.originalColor = WeaverVenomDisplay.Utils.Color(color.R, color.G, color.B);
    ...
    self.radioButtons["R"] = WeaverVenomDisplay.Utility.RadioButton(self.radioContainer, L:GetText("Red"), true);
    ...
    self.radioButtons["G"] = WeaverVenomDisplay.Utility.RadioButton(self.radioContainer, L:GetText("Green"), false);
    ...
    self.radioButtons["B"] = WeaverVenomDisplay.Utility.RadioButton(self.radioContainer, L:GetText("Blue"), false);
    ...
    self.radioButtons["H"] = WeaverVenomDisplay.Utility.RadioButton(self.radioContainer, L:GetText("Hue"), false);
    ...
    self.radioButtons["S"] = WeaverVenomDisplay.Utility.RadioButton(self.radioContainer, L:GetText("Saturation"), false);
    ...
    self.radioButtons["V"] = WeaverVenomDisplay.Utility.RadioButton(self.radioContainer, L:GetText("Value"), false);
    ...
    WeaverVenomDisplay.Utility.RadioButton.LinkPeers({self.radioButtons["R"], self.radioButtons["G"], self.radioButtons["B"], self.radioButtons["H"], self.radioButtons["S"], self.radioButtons["V"]});
    ...
    for colorName, color in pairs(Turbine.UI.Color) do
        if (Turbine.UI.Color:IsA(color) and (color.A == 1)) then
            color = WeaverVenomDisplay.Utils.Color(color.A, color.R, color.G, color.B);
...
function ColorPicker:AddRecentColor(newColor)
    ...
    for r = 1, #recentColors, 1 do
        ...
        oldColor = WeaverVenomDisplay.Utils.Color(oldColor.A, oldColor.R, oldColor.G, oldColor.B);
...
function ColorPicker:SelectDimension(sliderDimension)
    local paletteXDimension, paletteYDimension = WeaverVenomDisplay.Utils.Color.GetOtherDimensions(sliderDimension);
...
function ColorPicker:HexChanged()
    ...
    if (R and G and B) then
        self.hex:SetBackColor(WeaverVenomDisplay.Utils.Color(1, 1, 1, 1));
        ...
        self.hex:SetBackColor(WeaverVenomDisplay.Utils.Color(1, 1, 0, 0));
    end
end
...
function ColorPicker:UpdateHex()
    ...
    self.radioButtons["B"]:SetText(L:GetText("Blue") .. ": " .. tostring(B) .. "%");
